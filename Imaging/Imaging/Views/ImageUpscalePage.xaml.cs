...
namespace Imaging
{
    public partial class ImageUpscalePage : ContentPage
    {
        SKImage image;
        SKPixmap pixmap;

        public ImageUpscalePage()
        {
            InitializeComponent();
        }
        ...
        void OnProcessButtonClicked(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    pixmap = image.WaveletUpscale(Wavelet.Haar);
                    break;
                case 1:
                    pixmap = image.WaveletUpscale(Wavelet.Biorthogonal53);
                    break;
            }
            canvasView.InvalidateSurface();
